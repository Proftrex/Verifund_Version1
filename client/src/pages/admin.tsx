...
const ReportDetails = ({ report }: { report: any }) => {
  ...
  return (
    <div className="mt-4 p-4 bg-red-50 rounded-lg space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p><strong>Progress:</strong> {campaignDetails.raisedAmount && campaignDetails.goalAmount ? ((campaignDetails.raisedAmount / campaignDetails.goalAmount) * 100).toFixed(1) : 0}%</p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="space-y-2 text-sm">
                <p><strong>Created:</strong> {new Date(campaignDetails.createdAt).toLocaleDateString()}</p>
                <p><strong>Deadline:</strong> {campaignDetails.deadline ? new Date(campaignDetails.deadline).toLocaleDateString() : 'No deadline set'}</p>
                ...
                <p><strong>Tags:</strong> {campaignDetails.tags?.join(', ') || 'No tags'}</p>
              </div>
              <div>
                <p className="text-sm font-medium mb-1">Campaign Description:</p>
      ...
      {/* 4. Complete Creator Profile if available */}
      {creatorDetails && (
        <div className="bg-white p-4 rounded-lg border border-purple-200">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2 text-sm">
                <p><strong>Member Since:</strong> {new Date(creatorDetails.createdAt).toLocaleDateString()}</p>
                <p><strong>Birthday:</strong> {creatorDetails.birthday ? new Date(creatorDetails.birthday).toLocaleDateString() : 'N/A'}</p>
                <p><strong>Campaigns Created:</strong> {creatorDetails.campaignsCount || 0}</p>
                <p><strong>Total Raised:</strong> ₱{creatorDetails.totalRaised?.toLocaleString() || '0'}</p>
                <p><strong>Credibility Score:</strong> <Badge variant="outline">{creatorDetails.credibilityScore || 0}/100</Badge></p>
                <p><strong>Account Status:</strong> 
      ...
      {reporterDetails && (
        <div className="bg-white p-4 rounded-lg border border-orange-200">
          <h5 className="font-semibold mb-3 text-orange-700 flex items-center">
            🚨 Reporter Profile Who Filed This Report
          </h5>
          <div className="grid md:grid-cols-2 gap-6">
