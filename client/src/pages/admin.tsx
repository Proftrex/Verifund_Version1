            ...
            <div className="space-y-6">
              ...
              <Card className="border-gray-200">
                <CardHeader>
                  ...
                  <p className="text-sm text-gray-600">Basic details about the fraud report submission</p>
                </CardHeader>
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <div>
                        <label className="text-sm font-medium text-gray-500">Report ID</label>
                        <p className="text-sm font-mono bg-gray-50 p-2 rounded">{selectedReport.reportId || selectedReport.id}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-500">Type</label>
                        <div className="mt-1">
                          <Badge variant="outline">{selectedReport.reportType || selectedReport.type || 'N/A'}</Badge>
                        </div>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-500">Status</label>
                        <div className="mt-1">
                          <Badge variant={selectedReport.status === 'resolved' ? 'default' : 'secondary'}>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-sm bg-yellow-50 p-2 rounded border border-yellow-200">{selectedReport.reason || 'No reason provided'}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-500">Description</label>
                        <p className="text-sm bg-gray-50 p-2 rounded border">{selectedReport.description || selectedReport.details || 'No description provided'}</p>
                      </div>
                      {selectedReport.resolvedAt && (
                        <div>
                          <label className="text-sm font-medium text-gray-500">Resolved Date</label>
                          <p className="text-sm">{new Date(selectedReport.resolvedAt).toLocaleString()}</p>
                        </div>
                      )}
                      {selectedReport.adminNotes && (
                        <div>
                          <label className="text-sm font-medium text-gray-500">Admin Notes</label>
                          <p className="text-sm bg-blue-50 p-2 rounded border border-blue-200">{selectedReport.adminNotes}</p>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              <Card className="border-indigo-200">
                <CardHeader>
                  ...
                  <p className="text-sm text-gray-600">Direct links to view related entities and profiles</p>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    {/* Reporter Card */}
                    ...
                    <div className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium">Campaign</p>
                          <p className="text-xs text-gray-500">View reported campaign page</p>
                        </div>
                      </div>
                      <Button 
                        size="sm" 
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          const campaignId = selectedReport.campaignId || selectedReport.targetId;
                          if (campaignId) {
                            window.open(`/campaigns/${campaignId}`, '_blank');
                          } else {
                            alert('No campaign ID found in this report.');
              ...
              {selectedReport.reporter && (
                <Card className="border-blue-200">
                  <CardHeader>
                    ...
                    <p className="text-sm text-gray-600">Details about the user who submitted this fraud report</p>
                  </CardHeader>
                  <CardContent>
                    <div className="flex items-center gap-4">
                      <Avatar className="h-16 w-16">
                        <AvatarImage src={selectedReport.reporter.profileImageUrl} />
                        <AvatarFallback className="text-lg">{selectedReport.reporter.firstName?.[0]}{selectedReport.reporter.lastName?.[0]}</AvatarFallback>
                      </Avatar>
                      <div className="space-y-1">
                        <h5 className="text-lg font-semibold">{selectedReport.reporter.firstName} {selectedReport.reporter.lastName}</h5>
                        ...
                        {selectedReport.reporter.kycStatus && (
                          <Badge variant={selectedReport.reporter.kycStatus === 'verified' ? 'default' : 'secondary'}>
                            KYC: {selectedReport.reporter.kycStatus}
                          </Badge>
                        )}
                      </div>
                    </div>
              ...
              {selectedReport.campaign && (
                <Card className="border-green-200">
                  <CardHeader>
                    ...
                    <p className="text-sm text-gray-600">Details about the reported campaign</p>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div>
                        <label className="text-sm font-medium text-gray-500">Campaign Title</label>
                        <p className="text-lg font-semibold">{selectedReport.campaign.title}</p>
                      </div>
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <label className="text-sm font-medium text-gray-500">Campaign ID</label>
                          <p className="text-sm font-mono bg-gray-50 p-2 rounded">{selectedReport.campaign.campaignDisplayId}</p>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-gray-500">Status</label>
                          <div className="mt-1">
                            <Badge variant="outline">{selectedReport.campaign.status}</Badge>
                          </div>
                        </div>
                      </div>
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-lg font-bold text-green-600">₱{parseFloat(selectedReport.campaign.targetAmount || '0').toLocaleString()}</p>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-gray-500">Creator</label>
                          <p className="text-sm">{selectedReport.campaign.creator?.firstName} {selectedReport.campaign.creator?.lastName}</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
              ...
              {selectedReport.creator && (
                <Card className="border-purple-200">
                  <CardHeader>
                    ...
                    <p className="text-sm text-gray-600">Details about the reported creator</p>
                  </CardHeader>
                  <CardContent>
                    <div className="flex items-center gap-4">
                      <Avatar className="h-16 w-16">
                        <AvatarImage src={selectedReport.creator.profileImageUrl} />
                        <AvatarFallback className="text-lg">{selectedReport.creator.firstName?.[0]}{selectedReport.creator.lastName?.[0]}</AvatarFallback>
                      </Avatar>
                      <div className="space-y-1">
                        <h5 className="text-lg font-semibold">{selectedReport.creator.firstName} {selectedReport.creator.lastName}</h5>
                        ...
                        {selectedReport.creator.kycStatus && (
                          <Badge variant={selectedReport.creator.kycStatus === 'verified' ? 'default' : 'secondary'}>
                            KYC: {selectedReport.creator.kycStatus}
                          </Badge>
                        )}
                      </div>
                    </div>
...
function StoriesSection() {
  const { user } = useAuth();
  const { toast } = useToast();
  const [activeStoriesTab, setActiveStoriesTab] = useState("published");
  ...
  const createStoryMutation = useMutation({
    mutationFn: async (storyData: any) => {
      const response = await apiRequest('/api/admin/stories', {
        method: 'POST',
    ...
    onSuccess: () => {
      toast({
        ...
        description: "Your story has been successfully published and will appear in the Latest News section.",
      });
    ...
    onError: (error: any) => {
      toast({
        ...
        description: error.message || "There was an error publishing the story.",
        variant: "destructive",
      });
    }
  });
  ...
  const deleteStoryMutation = useMutation({
    mutationFn: async (storyId: string) => {
      const response = await apiRequest(`/api/admin/stories/${storyId}`, {
        method: 'DELETE'
      });
      return response;
    },
    ...
    onError: (error: any) => {
      toast({
        ...
        description: error.message || "There was an error deleting the story.",
        variant: "destructive",
      });
    }
  });
  ...
  const handleCreateStory = () => {
    if (!createStoryForm.title.trim() || !createStoryForm.body.trim()) {
      toast({
        title: "Missing Information",
        description: "Please fill in the title and body content.",
        variant: "destructive",
      });
      return;
    }
    ...
    const storyData = {
      ...createStoryForm,
      excerpt: createStoryForm.excerpt || createStoryForm.body.substring(0, 120) + '...'
    };
  ...
  const getFilteredStories = () => {
    ...
    switch (activeStoriesTab) {
      case 'published':
        return stories.filter((story: any) => story.status === 'published');
      case 'draft':
        return stories.filter((story: any) => story.status === 'draft');
      case 'archived':
        return stories.filter((story: any) => story.status === 'archived');
      default:
        return stories;
    }
  };
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6">
          ...
          <p className="mt-2 text-red-700">Only administrators and support staff can access story management.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Manage platform news, updates, and success stories</p>
      </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">Published Stories</p>
                <p className="text-2xl font-bold text-gray-900">
                  {stories?.filter((s: any) => s.status === 'published').length || 0}
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500">Draft Stories</p>
                <p className="text-2xl font-bold text-gray-900">
                  {stories?.filter((s: any) => s.status === 'draft').length || 0}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {stories?.reduce((sum: number, story: any) => sum + (story.viewCount || 0), 0) || 0}
                </p>
              </div>
            </div>
          </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <Tabs value={activeStoriesTab} onValueChange={setActiveStoriesTab}>
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger value="published" data-testid="tab-published-stories">
                Published ({stories?.filter((s: any) => s.status === 'published').length || 0})
              </TabsTrigger>
              <TabsTrigger value="draft" data-testid="tab-draft-stories">
                Drafts ({stories?.filter((s: any) => s.status === 'draft').length || 0})
              </TabsTrigger>
              <TabsTrigger value="archived" data-testid="tab-archived-stories">
                Archived ({stories?.filter((s: any) => s.status === 'archived').length || 0})
              </TabsTrigger>
            </TabsList>

            <TabsContent value={activeStoriesTab} className="mt-6">
              {!stories ? (
                <div className="flex items-center justify-center py-8">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-gray-600"></div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">No {activeStoriesTab} stories</p>
                  {activeStoriesTab === 'published' && (
                    <Button 
                      className="mt-4"
                      onClick={() => setShowCreateStory(true)}
                    >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center space-x-3 mb-2">
                            ...
                            <Badge variant={story.status === 'published' ? 'default' : 
                                           story.status === 'draft' ? 'secondary' : 'outline'}>
                              {story.status?.toUpperCase()}
                            </Badge>
                          </div>
                          
                          <p className="text-sm text-gray-600 mb-2 line-clamp-2">{story.excerpt || story.body?.substring(0, 120) + '...'}</p>
                          ...
                          <div className="flex items-center space-x-4 text-xs text-gray-500">
                            ...
                            <span>Reactions: {story.reactCount || 0}</span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-2 ml-4">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              toast({
                                title: "Edit Feature",
                                description: "Story editing functionality will be implemented soon.",
                              });
                            }}
      ...
      <Dialog open={showCreateStory} onOpenChange={setShowCreateStory}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            <div>
              <Label htmlFor="story-excerpt">Excerpt (Optional)</Label>
              <Input
                id="story-excerpt"
                placeholder="Brief summary for preview (auto-generated if empty)"
                value={createStoryForm.excerpt}
                onChange={(e) => setCreateStoryForm(prev => ({ ...prev, excerpt: e.target.value }))}
                data-testid="input-story-excerpt"
              />
            </div>

            <div>
              <Label htmlFor="story-cover-image">Cover Image URL (Optional)</Label>
              <Input
                id="story-cover-image"
                placeholder="https://example.com/image.jpg"
                value={createStoryForm.coverImageUrl}
                onChange={(e) => setCreateStoryForm(prev => ({ ...prev, coverImageUrl: e.target.value }))}
                data-testid="input-story-cover-image"
              />
            </div>

            <div>
              <Label htmlFor="story-cover-video">Cover Video URL (Optional)</Label>
              <Input
                id="story-cover-video"
                placeholder="https://example.com/video.mp4"
                value={createStoryForm.coverVideoUrl}
                onChange={(e) => setCreateStoryForm(prev => ({ ...prev, coverVideoUrl: e.target.value }))}
                data-testid="input-story-cover-video"
              />
            </div>

            <div>
              <Label htmlFor="story-body">Story Content</Label>
              <Textarea
                id="story-body"
            ...
            <div>
              <Label htmlFor="story-status">Publication Status</Label>
              <Select value={createStoryForm.status} onValueChange={(value) => setCreateStoryForm(prev => ({ ...prev, status: value }))}>
          ...
          <DialogFooter className="flex space-x-3">
            ...
            >
              {createStoryMutation.isPending ? 'Publishing...' : 
               createStoryForm.status === 'published' ? 'Publish Story' : 'Save Draft'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      {/* Story Detail Modal */}
      <Dialog open={showStoryDetail} onOpenChange={setShowStoryDetail}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="flex items-center space-x-2">
              <BookOpen className="h-5 w-5" />
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <Badge variant={selectedStory.status === 'published' ? 'default' : 
                                 selectedStory.status === 'draft' ? 'secondary' : 'outline'}>
                    {selectedStory.status?.toUpperCase()}
                  </Badge>
                </div>
                <p className="text-gray-600">{selectedStory.excerpt}</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-sm font-medium text-gray-700">Created</Label>
                  <p>{new Date(selectedStory.createdAt).toLocaleString()}</p>
                </div>
                {selectedStory.publishedAt && (
                  <div>
                    <Label className="text-sm font-medium text-gray-700">Published</Label>
                    <p>{new Date(selectedStory.publishedAt).toLocaleString()}</p>
                  </div>
                )}
                <div>
                  <Label className="text-sm font-medium text-gray-700">Views</Label>
                  <p>{selectedStory.viewCount || 0}</p>
                </div>
                <div>
                  <Label className="text-sm font-medium text-gray-700">Reactions</Label>
                  <p>{selectedStory.reactCount || 0}</p>
                </div>
              </div>

              {/* Story Content */}
              <div>
                <Label className="text-sm font-medium text-gray-700">Story Content</Label>
                <div className="mt-2 p-4 bg-gray-50 rounded-lg border max-h-64 overflow-y-auto">
                  <p className="whitespace-pre-wrap">{selectedStory.body}</p>
                </div>
              </div>
              ...
              <div className="flex space-x-3 pt-4 border-t">
                <Button
                  ...
                  data-testid="button-edit-story-modal"
                >
                ...
                <Button
                  ...
                  onClick={() => {
                    toast({
                      ...
                      description: "Detailed story analytics will be implemented soon.",
                    });
                  }}
