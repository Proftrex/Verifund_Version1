...
function ReportsSection() {
  ...
  // Handle claiming report functionality
        ...
        <Card>
          ...
          <CardContent>
            <Tabs value={activeTicketTab} onValueChange={setActiveTicketTab}>
              ...
              <TabsContent value="in-progress" className="mt-4">
                <div className="space-y-3">
                  <p className="text-center text-gray-500 py-8">No in-progress tickets</p>
                </div>
              </TabsContent>
              
              <TabsContent value="resolved" className="mt-4">
                <div className="space-y-3">
                  <p className="text-center text-gray-500 py-8">No resolved tickets</p>
                </div>
              </TabsContent>
            </Tabs>
          </CardContent>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-1">
              <nav className="flex space-x-1" data-testid="nav-main">
