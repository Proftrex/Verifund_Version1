  ...
  async getCampaignReports(): Promise<any[]> {
    try {
      ...
      const campaignReports = allFraudReports.filter((report: any) => {
        // Only include reports that are specifically about campaigns, not auto-generated creator reports
        ...
        const shouldInclude = isCampaignType && !isAutoGenerated;
        
        if (isCampaignType && isAutoGenerated) {
          console.log('❌ Excluding auto-generated creator report:', {
            id: report.id,
